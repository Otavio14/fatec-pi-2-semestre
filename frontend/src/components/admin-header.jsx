...
export const AdminHeader = () => {
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-[200px,1fr] overflow-hidden">
      <div className="hidden w-[200px] flex-col h-screen gap-8 bg-[#2b38d1] px-4 text-white md:flex">
        <NavLink to="/admin" className="flex flex-col items-center">
          <img
            alt="Logo da empresa"
            src="https://cdn-icons-png.flaticon.com/512/2964/2964514.png"
            className="mx-auto mt-[16px] mx-4 h-12 w-12 object-contain"
          />
          <p>Suplementos</p>
        </NavLink>
        ...
        <button
          onClick={logout}
          className="mx-auto w-fit rounded bg-[#dd3842] px-[34px] py-[15px] font-semibold leading-[20px] text-white"
        >
          Sair
        </button>
      </div>
